...
parser.add_argument('--data_dir', default='/home/yunyin/yueyang/毕业设计/UNETR/dataset/', type=str, help='dataset directory')
...
parser.add_argument('--space_x', default=0.001955, type=float, help='spacing in x direction')
parser.add_argument('--space_y', default=0.046878, type=float, help='spacing in y direction')
parser.add_argument('--space_z', default=0.011742, type=float, help='spacing in z direction')
# 0.011742     0.001955     0.046878 z, x, y
