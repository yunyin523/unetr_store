...
from utils.dataset_domain import CMRDataset
...
def get_loader(args):
    ...
    if args.test_mode:
        ...
        test_ds = CMRDataset(_data_path, mode='test', domain="A", transform=val_transform)
        ...
        #     )
        _data_path = args.data_dir
        train_ds = CMRDataset(_data_path, mode = 'train', transform=train_transform)
        ...
        val_ds = CMRDataset(_data_path, mode = 'validation', transform=train_transform)
